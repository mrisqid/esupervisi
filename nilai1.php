                  ...
                  <input name="Nip_Guru_Nilaia" type="hidden" value="<?php echo "$NIP_Guru_Jadwal"; ?>">
                    ...
                    <div class="box-body">
                      <table width="50%" border="1" align="center" cellpadding="5" cellspacing="1">
                        <tr bgcolor="#0c1f39">
                          <td bgcolor="#0c1f39"><div align="center" class="style8">
                            <h4>NO.</h4>
                          </div></td>
                          <td bgcolor="#0c1f39">
                        ...
                        <tr>
                          <td colspan="2">&nbsp;</td>
                          <td width="100"><div align="center" class="style6"> Ada </div></td>
                          <td width="100"><div align="center" class="style6"> Tidak Ada</div></td>
                        </tr>
                        <tr>
                          <td width="30"><div align="center" class="style6">1</div></td>
                          <td width="500" class="style6">Program Tahunan </td>
                          <td><div align="center">
...
<p>
                            ...
                            <p>
                              <input class="btn btn-default" type="submit" name="simpan" id="simpan" value="Save">
                            </p>
                          </div>	
                          <?php
