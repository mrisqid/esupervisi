        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
			        <li class="active"><a href="kepsek.php"><i class="fa fa-user"></i><span>Kepala Sekolah</span></a></li>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="kepsek_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
							<div><span class="form-group">
								<label>NIP</label>
									</span>
							  <div><span class="form-group">
								  </span><span class="input-group"><div class="input-group-addon">
									  <span class="form-group"><i class="fa fa-id-card"></i>
									      </span></div>
							...
							<div class="modal-footer">
								<button type="submit" class="btn btn-success  style1">
									Add
								</button>
								<button type="reset" class="btn btn-danger style1"  data-dismiss="modal" aria-hidden="true">
									Cancel
