    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
			        ...
			        <li class="active"><a href="jurusan.php"><i class="fa fa-university"></i><span>Sekolah</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-university"></i> Sekolah</li>
          </ol>
        </section>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title style4 style5">TAMBAH SEKOLAH </h4>
					</div>
							...
							<div class="form-group">
								<label>Kode Sekolah</label>
									<div class="input-group">
										...
										<input name="Kode_Sekolah" type="text" class="form-control" placeholder="Kode Sekolah"/>
									</div>
							</div>
							<div class="form-group">
								<label>Nama_Sekolah</label>
									<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-university"></i>
										</div>
										<input name="Nama_Sekolah" type="text" class="form-control" placeholder="Sekolah"/>
									</div>
							</div>
							<div class="form-group">
										...
										<select name="NIP_Kepsek_Sekolah" class="form-control">
											<?php
												...
												while($kepsek = mysqli_fetch_array($querykepsek)){
													echo "
														<option value='$kepsek[NIP_Kepsek]'>$kepsek[Nama_Kepsek]</option>";
												}
											?>
										</select>
									</div>
