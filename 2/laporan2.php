...
$queryjadwal = mysqli_query ($konek, "SELECT *FROM guru WHERE NIP_Guru='$nip'");
	...
	$kodesekolah=$data['Kode_Sekolah_Guru'];
			...
			$komen=$data['Komentar'];
			$namafile=$data['File'];
      $namafile2=$data['File2'];
      $namafile3=$data['File3'];
                ...
                <div class="box-body">
                  <form action="lappdf.php" method="post" enctype="multipart/form-data" name="form1">
                    ...
                    <table width="50%" border="0" align="center">
                      ...
                      <tr>
                        <td height="29"><div align="center"><span class="style3"><strong>LAPORAN HASIL PENILAIAN
                        </strong><p><strong>SUPERVISI AKADEMIK GURU</strong></p></span> </div></td>
                      </tr>
                    </table>
                    <p>&nbsp;</p>
                    <p align="center"></p>
                    ...
                    <table width="50%" border="0" align="center" cellpadding="5" cellspacing="1">
                      ...
                      <tr>
                        <td><p align="left">
                            <textarea name="Komentar" cols="70" rows="5" id="textarea" readonly><?php echo $komen;?></textarea>
                        </p></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>
                          <div align="left">
                            <?php echo "<a href=\"donlot.php?file=$namafile\"> $namafile </a> "?>
                          </div></td>
                      </tr>
                      <tr>
                        <td><div align="left">
                            <?php echo "<a href=\"donlot.php?file=$namafile2\"> $namafile2 </a> "?>
                          </div></td>
                      </tr>
                      <tr>
                        <td><div align="left">
                            <?php echo "<a href=\"donlot.php?file=$namafile3\"> $namafile3 </a> "?>
                          </div></td>
                      </tr>
                    </table>
                    <div align="center">
                      <table width="50%" height="38" border="0" align="center" cellpadding="5" cellspacing="1">
                        <tr>
                          <td><div align="right"><span class="style1">
                            <input type="submit" class="btn btn-primary" name="unduh" id="unduh" value="Download">
                          </span> </div></td>
                        </tr>
                      </table>
                      <br>
