...
-->
  ...
  <div class="logo">
<span class="logo-mini"><img src="../1/ic.PNG" class="img-circle" alt="Logo" height="50" width="50"></span>
<span class="logo-lg style1"><b>e-SUPERVISION</b></span>
  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <div class="pull-left">
                <a href="#" <button class="btn btn-primary" style="width:100px;font-size:13px;font-family:arial;text-align:center;color:white;" type="button" data-target="#ModalEditKepsek" data-toggle="modal"> <span>Edit Profil</span></button></a>
              </div>
...
?>
<!-- Modal Popup Dosen -->
		<div id="ModalEditKepsek" class="modal fade" tabindex="-1" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="user_edit_kepsek.php" name="modal_popup" enctype="multipart/form-data" method="post">
							...
							<div class="form-group">
								<label><span class="style1">Username</span></label>
									<div class="input-group">
										...
										<input name="User_Kepsek" type="text" class="form-control" value="<?php echo "".$_SESSION["Username"].""; ?>" readonly/>
									</div>
							</div>
                            <div class="form-group">
