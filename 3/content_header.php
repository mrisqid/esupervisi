...
-->
  ...
  <div class="logo">
<span class="logo-mini"><img src="../aset/foto/ic.PNG" class="img-circle" alt="Logo" height="50" width="50"></span>
<span class="logo-lg style1"><b>e-SUPERVISION</b></span>
</div>
  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <span style="color:white;font-family:arial;font-size:16px;">Welcome To e-SUPERVISION</span></li>
            <li class="user-footer">
    <div class="pull-left">
                <a href="#" <button class="btn btn-primary" style="width:100px;font-size:13px;font-family:arial;text-align:center;color:white;" type="button" data-target="#ModalEditGuru" data-toggle="modal"> <span>Edit Profil</span></button></a>
              </div>
              <div class="pull-right">
                <a href="../logout.php" class="btn btn-primary" style="width:100px;font-size:13px;font-family:arial;text-align:center;color:white;"><span class="style1">Sign out</span> </a>
              </div>
            </li>
        </li>
      </ul>
...
?>
<!-- Modal Popup Dosen -->
		<div id="ModalEditGuru" class="modal fade" tabindex="-1" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="user_edit_guru.php" name="modal_popup" enctype="multipart/form-data" method="post">
							...
							<div class="form-group">
								<label class="style1">Username</label>
									<div class="input-group">
										...
										<input name="User_Guru" type="text" class="form-control" value="<?php echo "".$_SESSION["Username"].""; ?>" readonly/>
									</div>
							</div>
                            <div class="form-group">
								<label class="style1">Password Baru</label>
									<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-user"></i>
										</div>
